...
delete mex_build_V_pone.mex*
%mex mex_build_V.cpp slpRectangle.cpp CFLAGS="\$CFLAGS -O2  -fopenmp" CXXFLAGS="\$CXXFLAGS -O2 -fopenmp" LDFLAGS="\$LDFLAGS -O2 -fopenmp"

%Alexx
mex mex_build_V_pone.cpp slpRectangle_pone.cpp CXXFLAGS="\$CXXFLAGS -O2 -fopenmp" 

mex mex_build_V.cpp slpRectangle_pone.cpp CXXFLAGS="\$CXXFLAGS -O2 -fopenmp" 
